...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { color_purple_new:"#4494c0",color_purple_black:"#060606",color_purple:"#fff", color_balck_grey:"#363636", purple_bg:"#815de9",navbackground:"#f3f3f3",color_balck:"060606",color_blue:"#060606",primaryblack:"#060606",textblack:"#ccc",orange_color:"#f3841e",orangetext_subhead:"#333",dash_heading:"#333",background: "#f3f3f3", textblack:"#333", backgroundDisabled: "#e6e6e8", contrast: "#1d2029", invertedContrast: "#FFFFFF", input: "#e6e6e8", inputSecondary: "#e6e6e8", tertiary: "#e0e0e0", text: "#060606", textDisabled: "#bdc2c4", textSubtle: "#1b9fa6", borderColor: "#e6e6e8", card: "#fff",  card_small: "#86b7ab", gradients: {
    bubblegum: "linear-gradient(139.73deg, #fff 0%, #fff 100%)",
} });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { color_purple_new:"#4494c0",color_purple_black:"#fff",color_purple:"#fff", color_balck_grey:"#fff", purple_bg:"#815de9",navbackground:"#020610",color_balck:"fff",color_blue:"#fff",primaryblack:"#fff",textblack:"#fff",orange_color:"#f3841e", orangetext_subhead:"#fff",dash_heading:"#fff",secondary: "#fff", textblack:"#fff", background: "#1f2b46", backgroundDisabled: "#1f2b46", contrast: "#FFFFFF", invertedContrast: "#10578aB3", input: "#0c1617", inputSecondary: "#10578aB3", primaryDark: "#0098A1", tertiary: "#0c1617", text: "#fff", textDisabled: "#666171",  card_small: "#86b7ab",textSubtle: "#fff", borderColor: "#524B63", card: "#020610", new: "#ffffff", gradients: {
