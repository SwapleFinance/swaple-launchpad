...
const test = (minamount).toFixed(18)
const slicevalue = SliceData(test)
setMin(slicevalue);
...
setBNBvalue(bnb);
console.log("BNBbalance",parseInt(BNBbalance) / 10 ** 18);
     ...
     <StyledFarmStakingCard className="white_box launc_card">
      ...
      <Text color="color_balck_grey" className="coin_name_title">
       {tokenName}
        ...
        <CardMidContent color="secondary">
         <ul className="coin_ul_desc">
             <li>
                 ...
                 <div>
                 <Text color="color_purple" className="coin_name_title"> 1 BNB = {priceToken} {tokenSymbol}</Text>
                 </div>
             </li>
             <li>
                 <div>
                 ...
                 <div>
                 <Text color="color_purple" className="coin_name_title">{hardCap} SWAP</Text>
                 </div>
             </li>
             ...
             <li>
                 ...
                 <div>
                 <Text color="color_purple" className="coin_name_title">{min} SWAP</Text>
                 </div>
             </li>
             <li>
                 <div>
                 ...
                 <div>
                 <Text color="color_purple" className="coin_name_title">{maxtoken} SWAP</Text>
                 </div>
             </li>
             <li>
                 <div>
        ...
        <p color="contrast" className="progress_txt">Progress ({bnbvalue} / {hardCap} SWAP) {(((bnbvalue)/parseInt(hardCap))*100).toFixed(2)} %</p>
          </div>
