...
border: 1px solid #5abfc3  !important;
...
.btn_yellow:hover
{
  ...
  background-image: linear-gradient(275deg,#4494c1 6%,#40a9bd 39%,#64c7c5);
 border-color:#5abfc3 !important;
box-shadow: 0px 0px 6px rgb(1 1 7 / 40%) !important;
color:#fff !important;
...
nav button {
  ...
  background-image: linear-gradient(275deg,#64c7c5 6%,#40a9bd 39%,#4494c1);
  box-shadow: 0px 0px 6px rgb(1 1 7 / 40%) !important;
  border-radius:30px !important;
  color:#fff !important;
  font-weight:600;
...
.banner_home h3,.banner_home .dash_subheading{
  color:#fff !important;
  font-weight:600;
...
{
  padding: 32px 32px !important;
  background-image: url('/images/app-farm.png');
...
.btn_orange
{
  background-image: linear-gradient(
    275deg,#64c7c5 6%,#40a9bd 39%,#4494c1);
        box-shadow: 0px 0px 6px rgb(1 1 7 / 40%) !important;
        border-radius: 30px !important;
        color: #fff !important;
font-weight:600 !important; 
...
.btn_blue:hover
{
  background-color: #5abfc3;
  background-image: linear-gradient( 
    275deg,#4494c1 6%,#40a9bd 39%,#64c7c5);
        border: 1px solid #5abfc3 !important;
        box-shadow: 0px 0px 6px rgb(1 1 7 / 40%) !important;
        border-radius: 30px !important;
        color: #fff !important;
...
.btn_green_new
{
  background-image: linear-gradient(to bottom,#3bc759 6%, #34c759 59%, #34c759);
...
.banner_home h3,.banner_home_launchpad h3
{
  text-transform:uppercase;
}
